...
<tileset version="1.8" tiledversion="1.8.2" name="axe" tilewidth="128" tileheight="128" tilecount="64" columns="6">
 <tileoffset x="0" y="-16"/>
 <image source="axe.png" trans="ff00ff" width="768" height="512"/>
 <tile id="5">
  <animation>
